...
function Dashboard({ user }: { user: User }) {
  ...
  async function cancelAppointment(a: Appointment) {
    if (
      !window.confirm(
        `${a.name || "Bu müşteri"} adlı randevuyu iptal etmek istediğinize emin misiniz?`
      )
    ) {
      return;
    }
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mt-6 grid gap-4 sm:grid-cols-3">
          <div className="rounded-2xl border border-white/[0.07] bg-white/[0.03] p-5">
            <div className="text-sm text-zinc-500">Seçilen Gün</div>
          ...
          <div className="rounded-2xl border border-white/[0.07] bg-white/[0.03] p-5">
            ...
            <div className="mt-2 text-3xl font-semibold text-[#C9A962]">
        ...
        <section className="mt-6 rounded-3xl border border-white/[0.07] bg-white/[0.025] p-4 sm:p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <input
              ...
              className="h-11 rounded-xl border border-white/[0.08] bg-black/40 px-3 text-sm text-white outline-none focus:border-[#C9A962]/50"
            />
          </div>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="mt-2 inline-flex rounded-full bg-green-500/10 px-2.5 py-1 text-xs font-medium text-green-300">
                        🟢 Onaylandı
                      </div>
                    ...
                    {a.phone && (
                      <>
                        <a
                          ...
                          className="rounded-xl border border-green-500/20 bg-green-500/5 px-4 py-2.5 text-sm font-medium text-green-300 transition hover:bg-green-500/10"
                        >
                          💬 WhatsApp
                        </a>
                        ...
                        <a
                          href={`tel:${a.phone}`}
                          className="rounded-xl border border-white/[0.08] bg-white/[0.03] px-4 py-2.5 text-sm font-medium text-zinc-300 transition hover:bg-white/[0.07] hover:text-white"
                        >
                          ☎ Ara
                        </a>
                      </>
